...
class NEURON: 
    ...
    def Update_Proximity_Neuron(self, click):
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight, pre_syn_neuron):
        val = weight * pre_syn_neuron
    ...
    def Is_Proximity_Neuron(self):

        return self.type == c.PROXIMITY_NEURON
    def Print(self):
