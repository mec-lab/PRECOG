...
def generate_eqn(csv_path, solutionID, runName):
    ...
    try:
        ...
        f2 = open("data/{}/eqn{}.txt".format(runName, solutionID), "w")
        f2.write("x : {} \n".format(eqn_x))
        f2.write("y : {} \n".format(eqn_y))
        f2.close()
    ...
    np.save('data/{}/pysrtime{}'.format(runName, solutionID), [end-start])
...
if __name__ == '__main__':
    generate_eqn('trajectories/gp_run1/trajectory1000.csv', 100, 'test')
    print("hello world")
